...
describe('log', () => {
    it('writes prefixed message to stderr', () => {
        ...
        log('test message');
        expect(spy).toHaveBeenCalledWith('[carbonlog] test message');
        spy.mockRestore();
    });
});
...
describe('logError', () => {
    it('writes error with details to stderr', () => {
        ...
        expect(spy).toHaveBeenCalledWith('[carbonlog] ERROR: something failed - bad thing');
        spy.mockRestore();
    });
    ...
    it('handles non-Error objects', () => {
        ...
        expect(spy).toHaveBeenCalledWith('[carbonlog] ERROR: failed - string error');
        spy.mockRestore();
    });
    ...
    it('works without error argument', () => {
        ...
        expect(spy).toHaveBeenCalledWith('[carbonlog] ERROR: just a message');
        spy.mockRestore();
    });
});
