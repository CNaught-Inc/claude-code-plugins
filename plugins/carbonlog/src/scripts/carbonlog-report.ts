...
import { getModelConfig, MILES_PER_KG_CO2 } from '../carbonlog-calculator';
import {
    getAggregateStats,
    getConfig,
    getDatabasePath,
...
async function main(): Promise<void> {
    try {
        ...
        // ── Footer ────────────────────────────────────────────
        console.log(
            `${c.dim}  Methodology: https://github.com/CNaught-Inc/claude-code-plugins/blob/main/plugins/carbonlog/methodology.md${c.reset}`
        );
