/**
 * Carbonlog Setup Check Script
 *
 * Checks whether the carbonlog plugin has been set up before and outputs
...
import { isPluginStatusLine } from './setup-helpers';
...
function checkStatusLine(): boolean {
    ...
    try {
        ...
        return typeof command === 'string' && isPluginStatusLine(command);
    } catch {
        return false;
    }
}
