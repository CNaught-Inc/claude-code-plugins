...
/**
 * Smart install script for the carbonlog plugin.
 *
...
if (!pluginRoot) {
    console.error('[carbonlog] smart-install: missing plugin root argument');
    process.exit(0);
}
...
console.error('[carbonlog] Installing dependencies...');
try {
    ...
    try {
        ...
        console.error('[carbonlog] smart-install: bun install failed', error);
