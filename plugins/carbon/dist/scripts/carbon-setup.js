...
function installStatusline() {
  ...
  const statuslineScript = path3.join(pluginRoot, "dist", "statusline", "carbon-statusline.js");
...
`;
  try {
    ...
    fs3.writeFileSync(statuslinePath, wrapper, { mode: 493 });
...
function configureSettings() {
  ...
  try {
    ...
    if (existingStatusLine && typeof existingStatusLine === "object" && typeof existingStatusLine.command === "string" && !existingStatusLine.command.includes("statusline-carbon")) {
      return {
        success: false,
